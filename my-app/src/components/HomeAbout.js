        ...
        <>
            <div className={'row about__container'}>
                <div className={'col-6 about__description'}>
                    ...
                    <p className={'about__description-text'}>Nori grape silver beet broccoli kombu beet greens fava bean potato quandong celery. Bunya nuts black-eyed pea prairie turnip leek lentil turnip greens parsnip.</p>
